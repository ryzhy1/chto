...
type UserService interface {
	...
	GetAllFriends(ctx context.Context, userId uuid.UUID) ([]*dto.User, error)
}
...
func (h *UserHandler) GetAllFriends(c *gin.Context) {
	...
	friends, err := h.userService.GetAllFriends(c.Request.Context(), userID)
	if err != nil {
		c.JSON(400, gin.H{"error": err.Error()})
		return
	}

	c.JSON(200, gin.H{"purchases": friends})
}
